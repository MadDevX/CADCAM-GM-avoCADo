...
namespace avoCADo
{
    ...
    public struct DrawCall
    {
        ...
        public DrawCall(int startIndex, int elementCount, DrawCallShaderType shaderType, float size, Color4 defaultColor, Color4 selectedColor, int patchCount, int outerTess0, int outerTess1, Vector2 patchCoords, Vector2 patchDims, 
            bool flipUV, bool trim, bool flipTrim)
        ...
        public DrawCall(int startIndex, int elementCount, DrawCallShaderType shaderType, float size, int patchCount, int outerTess0, int outerTess1, Vector2 patchCoords, Vector2 patchDims, 
            bool flipUV, bool trim, bool flipTrim)
            : this(startIndex, elementCount, shaderType, size, RenderConstants.PARAMETRIC_OBJECT_DEFAULT_COLOR, RenderConstants.PARAMETRIC_OBJECT_SELECTED_COLOR, patchCount, outerTess0, outerTess1, patchCoords, patchDims, flipUV, trim, flipTrim)
        {}
    }
