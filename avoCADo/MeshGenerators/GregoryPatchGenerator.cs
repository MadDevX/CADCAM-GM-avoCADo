...
namespace avoCADo.MeshGenerators
{
    public class GregoryPatchGenerator : IMeshGenerator, ICircularDependent<INode>
    {
        ...
        {
            var surfA = (_a.GetComponent<Renderer>()?.GetGenerator() as BezierPatchGenerator).Surface;
            var surfB = (_b.GetComponent<Renderer>()?.GetGenerator() as BezierPatchGenerator).Surface;
            var surfC = (_c.GetComponent<Renderer>()?.GetGenerator() as BezierPatchGenerator).Surface;
