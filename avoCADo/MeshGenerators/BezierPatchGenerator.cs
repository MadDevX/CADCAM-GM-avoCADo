    ...
    public class BezierPatchGenerator : IMeshGenerator, ISurfaceGenerator, ICircularDependent<INode>
    {
        ...
        private void SurfaceDrawCalls()
        {
            ...
            for(int u = 0; u < Surface.USegments; u++)
            {
                ...
                {
                    _drawCalls.Add(new DrawCall(0                        + PatchCount * (u + Surface.USegments * v), 16, SurfaceDrawType, RenderConstants.SURFACE_SIZE, PatchCount, IsolineDivisionsU, 64, new Vector2(u, v), dims, true, Trim, FlipTrim));
                    _drawCalls.Add(new DrawCall(_surfaceIndices.Length/2 + PatchCount * (u + Surface.USegments * v), 16, SurfaceDrawType, RenderConstants.SURFACE_SIZE, PatchCount, IsolineDivisionsV, 64, new Vector2(u, v), dims, false, Trim, FlipTrim));
                }
            }
        }
