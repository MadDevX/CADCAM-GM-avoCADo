...
namespace avoCADo
{
    public class GeneratedMeshRenderer : Renderer
    {
        protected IMeshGenerator _meshGenerator;

        public GeneratedMeshRenderer(ShaderWrapper shaderWrapper, IMeshGenerator meshGenerator, VertexLayout.Type type = VertexLayout.Type.Position) : base(shaderWrapper, type)
        {
